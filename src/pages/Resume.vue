      ...
      <main class="mt-1 mb-14">
        <div class="contain flex flex-col gap-7">
          <h1 class="font-semibold text-4xl">
            My Resume
            <a
              href="https://drive.usercontent.google.com/u/0/uc?id=1UqFOdEFIHScARIcsqwLKAjTzreWLcXJG&export=download"
              target="_blank" rel="noopener noreferrer"
              style="display:inline-block;background-color:#ffffff;border:none;color:black;padding:5px 10px;
