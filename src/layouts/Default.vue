    ...
    <footer class="contain flex justify-between mb-5 text-sl text-[#FFFFFF]">
      ...
      <p class="flex items-center space-x-2">
        Made With <app-icon class="pl-1" icon="fab fa-vuejs" size="lg"></app-icon> <app-icon class="pl-1"
          icon="fab fa-js" size="lg"></app-icon>
        <span class="ml-2">Deployed Using</span>
        <app-icon class="pr-1" icon="fab fa-docker" size="lg"></app-icon> <svg xmlns="http://www.w3.org/2000/svg"
